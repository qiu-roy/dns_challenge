...
storage_dir='D:/Work/Dataset/speech/DNS-Challenge'
#storage_dir='D:/Work/Dataset/speech/DNS-Challenge_Demand'
# If you want to clone the DNS-Challenge repo somewhere different
clone_dir=  # optional
#clone_dir='D:/Work/Dataset/speech/DNS-Challenge'
...
if [[ $stage -le  4 ]]; then
  ...
  $python_path eval_on_synthetic.py \
		--test_dir $clone_dir/datasets/test_set/synthetic \
